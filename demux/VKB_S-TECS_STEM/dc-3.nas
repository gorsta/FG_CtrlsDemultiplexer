...
var EngCtrls = [
    ...
    {name	: "Fuel controls", 
    aa_long	: ["adjust", ["L fuel valve\n%s;OFF|AUX RH|MAIN RH|MAIN LH|AUX LH|OFF", "/controls/fuel/left-valve", -1, 0, 5]],
    bb_long	: ["adjust", ["L fuel valve\n%s;OFF|AUX RH|MAIN RH|MAIN LH|AUX LH|OFF", "/controls/fuel/left-valve", 1, 0, 5]],
    d_long	: ["adjust", ["R fuel valve\n%s;OFF|AUX RH|MAIN RH|MAIN LH|AUX LH|OFF", "/controls/fuel/right-valve", -1, 0, 5]],
    e_long	: ["adjust", ["R fuel valve\n%s;OFF|AUX RH|MAIN RH|MAIN LH|AUX LH|OFF", "/controls/fuel/right-valve", 1, 0, 5]],
    c_short	: ["toggle", ["L booster pump\n%s;OFF|ON", "/controls/fuel/tank/boost-pump"]],
    f_short	: ["toggle", ["R booster pump\n%s;OFF|ON", "/controls/fuel/tank[1]/boost-pump"]],
    }, 
    
    {name	: "Magnetos & starter", 
    aa_long	: ["adjust", ["L engine magnetos: %s;OFF|L|R|BOTH", "/controls/engines/engine/magnetos", -1, 0, 3]],
    bb_long	: ["adjust", ["L engine magnetos: %s;OFF|L|R|BOTH", "/controls/engines/engine/magnetos", 1, 0, 3]],
    d_long	: ["adjust", ["R engine magnetos: %s;OFF|L|R|BOTH", "/controls/engines/engine[1]/magnetos", -1, 0, 3]],
    e_long	: ["adjust", ["R engine magnetos: %s;OFF|L|R|BOTH", "/controls/engines/engine[1]/magnetos", 1, 0, 3]],
    c_up		: ["adjust", ["L engine starter: %s;OFF|ON", "/controls/engines/engine/starter", -1]],
    c_down	: ["adjust", ["L engine starter: %s;OFF|ON", "/controls/engines/engine/starter", 1]],
    f_up		: ["adjust", ["R engine starter: %s;OFF|ON", "/controls/engines/engine[1]/starter", -1]],
    f_down	: ["adjust", ["R engine starter: %s;OFF|ON", "/controls/engines/engine[1]/starter", 1]],
    },
